...
export type { WorkContextCategory } from "./entities/WorkContextCategory";
...
export type { WorkContextCategoryRepository } from "./repositories/WorkContextCategoryRepository";
